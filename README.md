...
The character codes shown shoulw be printed inverted colour to show as a special character (or some other way to mark them as special versions of normal punctiation).
